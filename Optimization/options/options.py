...
def options_parser():
    ...
    parser.add_argument("--direction", type=str, help="[AtoB, BtoA] For AtoB one epoch trains every image in trainA and images from trainB are shuffled.")
    parser.add_argument("--direction_inference", type=str, help="[AtoB, BtoA] For AtoB images in inferenceA are used in inference mode.")
